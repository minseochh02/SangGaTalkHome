          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="ml-4 space-y-4">
                <div>
                  <h4 className="text-lg font-medium text-gray-700">방법 A: 앱/웹사이트 내 탐색</h4>
                  <ul className="list-disc list-inside text-gray-600 space-y-1 mt-2">
                    <li>앱 또는 웹사이트에서 상점이나 카테고리를 검색하여 시작하세요.</li>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">상점에 비치된 QR 코드를 찾으세요. 스마트폰 카메라나 QR 스캔 앱을 사용하여 스캔하면 해당 상점의 키오스크 페이지로 바로 이동합니다.</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">키오스크 인터페이스가 로드되면 상점 이름과 환영 메시지가 표시됩니다. 상품 카테고리를 탐색하거나 상품 목록을 스크롤하세요.</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">장바구니 아이콘에는 상품 수량과 총액이 표시됩니다. 아이콘을 탭하여 주문 요약을 확인하세요. 상품 수량을 변경하거나 삭제할 수 있습니다.</p>
            ...
            <div>
              <h3 className="text-xl font-medium text-gray-700 mb-3">5. 결제 진행 및 정책 검토</h3>
            ...
            <div>
              <h3 className="text-xl font-medium text-gray-700 mb-3">6. 결제 및 주문 확인</h3>
            ...
            <div>
              <h3 className="text-xl font-medium text-gray-700 mb-3">7. 주문 준비 완료 알림</h3>
        ...
        <section>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-3">상가톡 판매자 대시보드에 로그인하세요. 상점 설정으로 이동하여 "키오스크 관리" 또는 "키오스크 화면 편집" 섹션을 찾으세요.</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">상품이 시스템에 있는지 확인하세요. 듀얼 패널 레이아웃("사용 가능한 상점 상품" vs. "키오스크 메뉴 레이아웃")을 사용하여 상품을 키오스크 메뉴로 드래그하세요. 항목을 드래그 앤 드롭하여 순서를 변경하세요. "카테고리 구분선"을 추가, 이름 지정 및 배치하세요.</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">변경 후 "키오스크 설정 저장" 또는 "키오스크에 게시"를 클릭하여 업데이트를 적용하세요.</p>
