...
const AddDividerPlaceholder: React.FC<AddDividerPlaceholderProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="relative my-1 h-0 group"
    >
      {/* Invisible hit area that expands on hover */}
      <div className="absolute inset-x-0 -top-2 -bottom-2 flex items-center justify-center cursor-pointer">
        {/* The visible element that appears on hover */}
        <div className="w-full h-8 flex items-center justify-center opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-200 ease-in-out">
          <div className="bg-blue-50 hover:bg-blue-100 rounded-md px-4 py-2 flex items-center text-blue-500 shadow-sm">
