                          ...
                          <tbody>
                            {expandedOrderItems[order.kiosk_order_id].map((item) => (
                              <tr key={item.kiosk_order_item_id} className="border-b">
                                ...
                                <td className="py-2 text-right">{Number(item.price_at_purchase).toLocaleString()}원</td>
                                <td className="py-2 text-right">{item.quantity}개</td>
                                <td className="py-2 text-right">{(Number(item.price_at_purchase) * item.quantity).toLocaleString()}원</td>
                              </tr>
                            ))}
                          </tbody>
                          <tfoot>
                            <tr className="font-bold">
                              ...
                              <td className="py-2 text-right">{Number(order.total_amount).toLocaleString()}원</td>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
