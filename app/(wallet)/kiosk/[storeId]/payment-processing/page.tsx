        ...
        <div className="max-w-lg mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-xl">
          ...
          <div className="mt-8 text-xs text-gray-500 text-center">
            <div className="mt-6 border-t border-gray-200 pt-4 text-xs text-gray-600 leading-relaxed text-left">
              <p className="mb-2">회사는 모든 거래에 대한 책임과 배송, 교환, 환불 민원등의 처리는 회사 고객센터에서 진행합니다.</p>
              <p className="mb-2">사세한 문의는 email: quusai.space@gmail.com, 유선 : 070-4024-5884 으로 가능합니다.</p>
              <p> (주)쿠스</p>
            </div>
          </div>
        </div>
